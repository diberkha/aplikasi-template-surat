        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-col lg:flex-row lg:items-center gap-3 mt-4 lg:mt-0 w-full lg:w-auto">
                <div class="flex items-center gap-2 w-full lg:w-auto">
                    ...
                    <div x-data="{ toggleCategory: false }" class="relative flex-1 lg:flex-none lg:w-32">
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('draftCuti', () => ({
                ...
                arsipkanDraft(id, title) {
                    ...
                    const btnConfirm = document.getElementById('btnConfirmArsipkanCuti');

                    const newBtn = btnConfirm.cloneNode(true);
                    btnConfirm.parentNode.replaceChild(newBtn, btnConfirm);

                    newBtn.addEventListener('click', () => {
                        fetch("{{ route('cuti.archive', ':id') }}".replace(':id', id), {
                            method: 'POST',
                            headers: {

<div id="modalDeleteUndangan" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center p-4 z-50">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full overflow-hidden">
        ...
        <div class="p-6">
            ...
            <div class="mt-4 bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
                <p class="text-sm mb-2">
                    ...
                    <span id="delete-nama-undangan" class="text-gray-800 dark:text-gray-200">-</span>
                </p>
            </div>
        </div>
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
            ...
            <button type="button" id="btnConfirmDeleteUndangan"

    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full overflow-hidden">
        <div
            ...
            <h3 class="text-base sm:text-lg font-semibold text-green-600 dark:text-green-400 truncate pr-4">Konfirmasi
                Arsipkan</h3>
            <button onclick="closeModal('modalArsipkanUndangan')"
        ...
        <div class="p-6">
            ...
            <div
                ...
                <p class="text-sm mb-2">
                    ...
                    <span id="arsipkan-nama-undangan" class="text-gray-800 dark:text-gray-200">-</span>
                </p>
            </div>
        </div>

        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
            <button type="button" onclick="closeModal('modalArsipkanUndangan')"
            ...
            <button type="button" id="btnConfirmArsipkanUndangan"

<div id="modalArsipkanSop"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            ...
            <button onclick="closeModal('modalArsipkanSop')" class="text-gray-400 hover:text-gray-600">
                <i class="fas fa-times"></i>
            </button>
        </div>

        <div class="p-6">
            <p class="text-sm text-gray-600 dark:text-gray-400">Apakah Anda yakin ingin mengarsipkan Standar Operasional
                Prosedur ini ke dalam arsip? Setelah diarsipkan, surat tidak dapat diubah kembali.</p>
            <div
                ...
                <p class="text-sm mb-2">
                    ...
                    <span id="arsipkan-judul-sop" class="text-gray-800 dark:text-gray-200">-</span>
                </p>
            </div>
        </div>

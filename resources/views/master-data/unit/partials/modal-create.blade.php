<div id="modalCreateUnit" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center p-4 z-50">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full relative overflow-hidden">
        <button type="button" onclick="closeModal('modalCreateUnit')"
        ...
        <div class="p-6">
            <form id="formCreateUnit" action="{{ route('master-data.unit.store') }}" method="POST">
                @csrf
                <div class="space-y-6">
                    <div>
        ...
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
            <div class="flex justify-end space-x-3">
                <button type="button" @click="document.getElementById('formCreateUnit').reset()"
                ...
                <button type="submit" form="formCreateUnit"

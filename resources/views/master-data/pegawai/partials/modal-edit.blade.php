                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <div class="lg:col-span-1">
                        ...
                        <div class="relative" x-data="{ 
                            ...
                            <button type="button" @click="open = !open"
                                ...
                                <span x-text="selected || 'Pilih Jenis'"
                                    :class="!selected && 'text-gray-400 font-normal'"
                                    class="font-normal text-gray-700 dark:text-gray-300"></span>
                    ...
                    <div class="lg:col-span-1">
                        <label class="block mb-2 text-sm text-gray-700 dark:text-gray-300"
                            id="label_masa_kerja_edit">TMT CPNS <span class="text-red-500">*</span></label>

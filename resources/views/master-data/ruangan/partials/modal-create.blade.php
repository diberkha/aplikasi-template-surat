<div id="modalCreate" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center p-4 z-50">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full relative overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Tambah Ruangan</h3>
        </div>
            ...
            <form id="formCreateRuangan" action="{{ route('master-data.ruangan.store') }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="nama_ruangan" id="create_nama_ruangan" required
        ...
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
            <div class="flex justify-end space-x-3">
                <button type="button" @click="document.getElementById('formCreateRuangan').reset()"
                ...
                <button type="submit" form="formCreateRuangan" id="btnSubmitCreateRuangan"

<div id="modalCreateUser" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center p-4 z-50">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full relative">
        ...
        <button type="button" @click="document.getElementById('modalCreateUser').classList.add('hidden')"
        ...
        <div class="p-6">
            <form id="formCreateUser" action="{{ route('master-data.user.store') }}" method="POST">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block mb-2 text-gray-700 dark:text-gray-300">Password <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label class="block mb-2 text-gray-700 dark:text-gray-300">Konfirmasi Password <span
                                class="text-red-500">*</span></label>

<div id="modalDeleteUser" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center p-4 z-50">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full relative overflow-hidden">

        <button type="button" @click="document.getElementById('modalDeleteUser').classList.add('hidden')"
        ...
        <div class="p-6">
            <p class="text-gray-600 dark:text-gray-400 mb-4">
                Apakah Anda yakin ingin menghapus data user ini? Data yang dihapus tidak dapat dikembalikan.
            </p>
            <div class="mt-4 bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
                <p class="text-sm mb-2">
                    <span class="font-medium text-gray-700 dark:text-gray-300">Ruangan:</span>
                    <span id="delete-ruangan-user" class="text-gray-800 dark:text-gray-200">-</span>
                </p>
                <p class="text-sm">
                    <span class="font-medium text-gray-700 dark:text-gray-300">Username:</span>
                    <span id="delete-username" class="text-gray-800 dark:text-gray-200">-</span>
                </p>
            </div>
        </div>

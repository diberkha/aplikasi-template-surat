                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center space-x-2">
                                <button @click="openSKModal('modalCreateSK', 'Surat Keputusan Direktur', item.id_template_surat)"
                                ...
                                <button @click="openDeleteModal(item.nama_template_surat, item.id_template_surat)"
...
<script>
    ...
    function openDeleteModal(templateName, templateId) {
        ...
        window.openModal('modalDeleteTemplate');
    }

    ...
    <div
        ...
        <div
            ...
            <div class="flex-1 min-w-0">
                <h3 class="text-sm sm:text-base font-semibold text-gray-900 dark:text-white truncate">Preview Surat Undangan</h3>
            ...
            <div class="flex items-center space-x-1.5 sm:space-x-3 shrink-0">
                ...
                <div x-data="{ openDropdown: false }" class="relative">
                    ...
                    <div x-show="openDropdown" @click.outside="openDropdown = false" x-transition x-cloak
                        ...
                        <a :href="'{{ url('/template-surat/surat-undangan/docx') }}/' + suratId" :download="downloadDocxFilename"
        ...
        return {
            ...
            get downloadFilename() {
                if (this.nomorSurat) {
                    ...
                    return `Surat Undangan-${cleanNomor}.pdf`;
                }
                return 'Surat_Undangan.pdf';
            },

            get downloadDocxFilename() {
                if (this.nomorSurat) {
                    const cleanNomor = this.nomorSurat.replace(/[\/\\*:\?"<>|]/g, '-');
                    return `Surat Undangan-${cleanNomor}.docx`;
                }
                return 'Surat_Undangan.docx';
            },
            ...
            close() {
                ...
                if (this.shouldReloadOnClose) {
                    ...
                    setTimeout(() => {
                        window.location.href = "{{ route('draft-surat.surat-undangan.index') }}";
                    }, 1000);
                }
            },
            ...
            downloadAs(format) {
                ...
                let downloadUrl = `/arsip-surat/${this.suratId}/download`;

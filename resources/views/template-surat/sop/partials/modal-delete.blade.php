<div id="modalDeleteSOP" class="fixed inset-0 z-[60] hidden" role="dialog" aria-modal="true">
    <div class="fixed inset-0 bg-gray-500/75 dark:bg-gray-900/80 backdrop-blur-sm transition-opacity"
        onclick="closeModal('modalDeleteSOP')"></div>
    ...
    <div class="flex items-center justify-center min-h-screen p-4 sm:p-6 lg:p-8">
        <div
            ...
            <div
                class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3 rounded-b-xl">
                <button type="button" onclick="closeModal('modalDeleteSOP')"
                ...
                <form id="formDeleteTemplateSOP" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit"

<div id="modalPreviewPDFNonASN" x-data="previewPDFNonASN()" x-show="isOpen" x-cloak
            ...
            <div class="flex items-center space-x-3">
                ...
                <div x-data="{ openDropdown: false }" class="relative">
                    ...
                    <div x-show="openDropdown" @click.outside="openDropdown = false" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 py-1 z-50">
                        ...
                        <a :href="'{{ url('template-surat/cuti/nonasn/docx') }}/' + suratId" class="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">
...
<script>
        ...
        return {
            ...
            get downloadFilename() {
                if (this.nomorSurat) {
                    ...
                    return `Surat Izin Cuti-Non ASN-${nama}.pdf`;
                }
                return 'Surat_Izin_Cuti_Non_ASN.pdf';
            },
    ...
    function openPreviewPDFNonASN(fileUrl, nomorSurat, suratId = null, judulSurat = '', tanggalDibuat = '') {
        const modalEl = document.getElementById('modalPreviewPDFNonASN');

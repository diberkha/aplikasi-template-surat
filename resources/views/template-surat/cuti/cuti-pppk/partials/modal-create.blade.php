    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-4xl w-full">
        ...
        <form action="{{ route('template-surat.cuti.store') }}" method="POST" id="cutiFormPPPK" onsubmit="submitCutiFormPPPK(event)">
            ...
            <div class="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                    ...
                    <div class="p-4 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" id="pegawai_reset_pppk" class="hidden absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                            ...
                            <div>
                                ...
                                <input type="text" name="form[nip]" id="nip_pegawai_pppk" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="form[jabatan]" id="jabatan_pegawai_pppk" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                            </div>
                            <div class="col-span-2 md:col-span-1">
                                <label class="block mb-2 text-gray-700 dark:text-gray-300">Masa Kerja</label>
                                <div class="flex items-center space-x-2">
                                    <input type="number" name="form[masa_kerja_tahun]" id="masa_kerja_tahun_pppk" readonly
                                    ...
                                    <input type="number" name="form[masa_kerja_bulan]" id="masa_kerja_bulan_pppk" readonly
                                        class="w-24 px-3 py-2 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed" />
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" name="form[lama_cuti]" id="lama_cuti_pppk" required min="1" class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                            </div>
                            <div>
                ...
                <div id="sisa_cuti_container_pppk" class="hidden border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden">
                    <div class="bg-gray-100 dark:bg-gray-700 px-4 py-3 border-b border-gray-300 dark:border-gray-600">
                    ...
                    <div class="p-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="atasan_search_pppk" autocomplete="off" 
                                        class="w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all" 
                                        placeholder="Cari nama...">
                                    <button type="button" id="atasan_reset_pppk" class="hidden absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                        <i class="fas fa-times-circle text-lg"></i>
                                    </button>
                                </div>
                                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            ...
                            <div>
                                ...
                                <input type="text" name="form[nip_atasan]" id="nip_atasan_pppk" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                            </div>
                        </div>
                        <div>
                            <label class="block mb-2 text-gray-700 dark:text-gray-300">Jabatan Atasan</label>
                            <input type="text" name="form[jabatan_atasan]" id="jabatan_atasan_pppk" readonly class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                        </div>
                    </div>
                </div>
            </div>

    ...
    (function () {
        ...
        function selectPegawai(id) {
            ...
            if (data) {
                ...
                document.getElementById('masa_kerja_tahun_pppk').value = data.masa_kerja_tahun || 0;
                document.getElementById('masa_kerja_bulan_pppk').value = data.masa_kerja_bulan || 0;

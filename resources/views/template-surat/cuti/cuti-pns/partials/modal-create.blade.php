<div id="modalCreateCuti" class="hidden fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center p-4 z-50">
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-4xl w-full overflow-hidden">
        <div
            ...
            <button onclick="closeModal('modalCreateCuti')"
                class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                <i class="fas fa-times text-lg"></i>
            </button>
        </div>

        <form action="{{ route('template-surat.cuti.store') }}" method="POST" id="cutiForm"
            onsubmit="submitCutiForm(event)" x-data="{ openJenisCuti: false, jenisCuti: '', jenisCutiLabel: '', jenisCutiOptions: [
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" id="pegawai_reset"
                            ...
                            <div>
                                <label class="block mb-2 text-gray-700 dark:text-gray-300">NIP <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="form[nip]" id="nip_pegawai" readonly
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block mb-2 text-gray-700 dark:text-gray-300">Jabatan <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="form[jabatan]" id="jabatan_pegawai" readonly
                                    class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="atasan_search" autocomplete="off" required
                                        class="w-full pl-10 pr-10 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500 transition-all"
                                        placeholder="Cari nama...">
                                    <button type="button" id="atasan_reset"
                                        class="hidden absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                                        <i class="fas fa-times-circle text-lg"></i>
                                    </button>
                                </div>
                            ...
                            <div>
                                <label class="block mb-2 text-gray-700 dark:text-gray-300">NIP Atasan <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="form[nip_atasan]" id="nip_atasan" readonly
                                    class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                            </div>
                        </div>
                        <div>
                            <label class="block mb-2 text-gray-700 dark:text-gray-300">Jabatan Atasan <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="form[jabatan_atasan]" id="jabatan_atasan" readonly
                                class="w-full px-4 py-3 bg-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-600 dark:text-gray-300 cursor-not-allowed">
                        </div>
                    </div>
                </div>
            ...
            <div
                ...
                <button type="button" @click="document.getElementById('cutiForm').reset(); jenisCuti = ''; jenisCutiLabel = ''"
        ...
        function selectPegawai(id) {
            ...
            if (data) {
                ...
                if (data.masa_kerja) {
                    ...
                    document.getElementById('masa_kerja_tahun').value = years;
                    document.getElementById('masa_kerja_bulan').value = months;
                } else {
                    document.getElementById('masa_kerja_tahun').value = 0;
                    document.getElementById('masa_kerja_bulan').value = 0;
                }

<div id="modalDeleteCutiBersama"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full relative">
        <button type="button" onclick="closeModal('modalDeleteCutiBersama')"
        ...
        <div class="p-6">
            <p class="text-gray-600 dark:text-gray-400 mb-4">
                Apakah Anda yakin ingin menghapus data cuti bersama ini? Data yang dihapus tidak dapat dikembalikan.
            </p>
            <div
                class="mt-4 bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                <p class="text-sm">
                    <span class="font-medium text-gray-700 dark:text-gray-300">Jenis Cuti Bersama:</span>
                    <span id="delete-nama-cuti" class="text-gray-800 dark:text-gray-200">-</span>
                </p>
            </div>
        </div>
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
            ...
            <form id="formDeleteCutiBersama" method="POST">
                @csrf
                @method('DELETE')
                <button type="submit"
                    class="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 text-sm transition-all">
                    Hapus
                </button>
            </form>
        </div>

    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-md w-full relative overflow-hidden">
        ...
        <div class="p-6">
            <form id="formEditCutiBersama" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        <label for="edit_nama_cuti" class="block mb-2 text-gray-700 dark:text-gray-300">Jenis Cuti
                            Bersama <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="edit_tahun" class="block mb-2 text-gray-700 dark:text-gray-300">Tahun <span
                    ...
                    <div>
                        <label for="edit_jumlah_hari" class="block mb-2 text-gray-700 dark:text-gray-300">Lama Cuti
                    ...
                    <div>
                        <label for="edit_catatan" class="block mb-2 text-gray-700 dark:text-gray-300">Catatan <span
        ...
        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
            <div class="flex justify-end space-x-3">
                ...
                <button type="submit" form="formEditCutiBersama" id="btnSubmitEditCutiBersama"
